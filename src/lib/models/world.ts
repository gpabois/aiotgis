...
export interface WorldMeta {
    collections: FeatureCollectionMeta[];
}

export class World {
    meta: WorldMeta;
    collections: {[name: string]: FeatureCollection};

    constructor(args: {meta: WorldMeta, collections: {[name: string]: FeatureCollection}}) {
        this.meta = args.meta;
    ...
    addFeatureCollection(meta: FeatureCollectionMeta, collection: FeatureCollection) {
